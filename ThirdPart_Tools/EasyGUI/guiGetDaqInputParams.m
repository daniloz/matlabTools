...
myBufferSize = gui.editnumber('Buffer Size (samples)', myGui);
myBufferSize.LabelLocation = 'left';
myBufferSize.Enable = false;
...
if ~allOk || myGui.LastInput == myCancelBtn
    ...
    out.bufferSize = myBufferSize.Value;
...
%%
    function boardIdCallback(h) %#ok<INUSD>
        ...
        myBoardName.Value = myAnalogInputInfo.DeviceName;
