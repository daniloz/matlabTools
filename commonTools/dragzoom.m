...
%   Created   : 10.07.10
%   Updated   : 05.06.11
%   Updated   : 18.08.11 by Danilo Zanatta
%
...
%FIXME: #dz# 'd' command not able to turn off data cursor mode - look at callbacks
...
%==========================================================================
    function SetDataCursorKeys()
        %SetDataCursorKeys on/off data cursor
