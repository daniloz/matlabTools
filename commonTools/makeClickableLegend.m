...
% Modified clickable Legend by Danilo Zanatta...
% Input:
%   - ax: axes
...
% Extract what is needed from the legend from the axes _ax_
[legend_h,objhan,plothan,text_strings] = legend(ax); %#ok<ASGLU,NASGU>
